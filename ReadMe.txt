========================================================================
    Win32 アプリケーション: gameConlyDx プロジェクトの概要
========================================================================

この gameConlyDx アプリケーションは、AppWizard により作成されました。

このファイルには、gameConlyDx 
...
gameConlyDx.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル gameConlyDx.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル gameConlyDx.rc 
    にインクルードされます。
